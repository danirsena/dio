...
class CustomerResourceTest {
    ...
    private fun builderUpdatedCustomerDTO(

        firstName: String = "Lupusregina",
        lastName: String = "Beta",
        zipCode: String = "22222222",
        street: String = "Grande Tumba de Nazarick",
        income: BigDecimal = BigDecimal.valueOf(900.0)
    ) = UpdateCustomerDto(
